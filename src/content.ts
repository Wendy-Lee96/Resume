...
export interface Project {
  ...
  tags: string[]
  overview: string
  businessValue: { summary: string; points: string[] }
...
export const projects: Project[] = [
  {
    ...
    businessValue: {
      summary: '以语音+大模型重构中控屏交互，把自然语言控制做成可规模复制的地产交付能力，直接支撑精装房智能化卖点与交付效率。',
      points: [
        '15.6 寸中控屏 AI 引导准确率 98.19%、落域识别 99.90%，降低误唤醒与无效指令带来的售后与培训成本。',
        '18 个地产项目、10720 个家庭落地，成为精装房智能化交付标准件，扩大可售智能化规模。',
        '语音创建场景、说明书问答减少业主学习成本，提升交付满意度与品牌口碑。',
      ],
    },
    results: [
  ...
  },
  {
    ...
    businessValue: {
      summary: '打通从设备控制、场景自动化到运营分析的全链路，把智能家居从"能用"做成"可运营、可度量"的资产。',
      points: [
        '支撑 52013 用户、1437 接入家庭、7066 中控终端，形成规模化运营基数与可变现的服务规模。',
        '用户投诉 ↓39.5%，直接降低售后工单量与客服/上门成本。',
        '全屋体检等功能获国家级奖励，强化品牌背书与招投标竞争力。',
      ],
    },
    results: [
  ...
  },
  {
    ...
    businessValue: {
      summary: '把建材家装供应从线下/邮件流转改为系统化协同，缩短交易链路、提升履约与运营效率，并拓展外部销售市场。',
      points: [
        '下单时长 ↓80%，减少采购/销售等待与反复沟通的人力成本。',
        '运营效率 ↑20%，打通系统数据交换，降低信息错漏与对账成本。',
        '支撑内外部企业商品供应，打开外部营收与市场空间。',
      ],
    },
    results: [
  ...
  },
  {
    ...
    businessValue: {
      summary: '以低碳智慧办公示范项目验证可复用的智慧空间方案，为集团后续智慧办公业务打样并沉淀标准。',
      points: [
        '智慧门禁、接待/会议室线上化，减少前台与行政人力投入。',
        '感应节能系统降低大厦能耗与日常运营成本。',
        '形成可复制的示范方案，支撑集团智慧办公业务规模化拓展。',
      ],
    },
    results: [
  ...
  },
  {
    ...
    businessValue: {
      summary: '搭建商办/商业多业态闭环 ERP，把分散的资产与租赁数据统一透明，提升资管效率与经营决策质量。',
      points: [
        '多业态统一上线，提升大厦/商业资产管理与运营效率。',
        '资产数据透明化，减少账实不符与租赁收入漏记风险。',
        '统一数据指标与共享流程标准，降低跨子公司协作成本。',
      ],
    },
    results: [
  ...
  },
  {
    ...
    businessValue: {
      summary: '从传统人力向数字化人力转型，靠业财一体化盘活数据资产、降低流转成本、拓展外包服务规模。',
      points: [
        '14 家 HRO 客户接入，拓展外包服务规模与持续营收。',
        '流转时间成本 ↓30%、V2.0 效率 ↑80%，降低人工与跨部门沟通成本。',
        '数据留存 ↑35%，为经营分析与数据复用提供基础资产。',
      ],
    },
    results: [
  ...
  },
  {
    ...
    businessValue: {
      summary: '猎头业务数字化转型，用 OCR 与 SaaS 化提升人均产能与简历转化效率，形成可对外输出的产品能力。',
      points: [
        '猎头效率 ↑32%、简历录入 ↑280%，提升单人产出与营收能力。',
        'OCR 识别 97%，减少人工录入工时与错漏。',
        '整合人力板块产品线，沉淀可对外输出的 SaaS 能力。',
      ],
    },
    results: [
      { value: '↑32%', label: '猎头效率' },
  ...
  },
  {
    ...
    businessValue: {
      summary: '数据治理与中台落地的运营抓手，把数据资产变成可见、可用的日常入口，提升跨部门协作与决策效率。',
      points: [
        'DAU ↑87.5%，数据门户成为各业务日常运营入口。',
        '跨部门效率 ↑325%，减少数据查找与口径对齐的时间成本。',
        '支撑 5 大中台业务落地，沉淀数据治理标准与复用能力。',
      ],
    },
    results: [
